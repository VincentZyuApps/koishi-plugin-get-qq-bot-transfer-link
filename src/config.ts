...
export interface Config {
  ...
  /** 🔗 是否在迁移链接消息末尾附带迁移 URL 🔗 */
  qqTransferLinkGuideShowUrl: boolean
...
export const Config: Schema<Config> = Schema.intersect([
  ...
  /** 🖼️ qqTransferLinkGuideShowImage — 迁移链接操作提示图片开关 🖼️ */
  ...
  /** 🔗 qqTransferLinkGuideShowUrl — 迁移 URL 显示开关 🔗 */
  qqTransferLinkGuideShowUrl: Schema.boolean()
    .default(true)
    .description('🔗 在迁移链接消息末尾附带迁移 URL（QQ Markdown、QQ 纯文本和非 QQ 平台均生效）'),
  ...
  /** 🖼️ qqUiSettingsGuideShowImage — 手机 QQ UI 手动配置指南图片开关 🖼️ */
